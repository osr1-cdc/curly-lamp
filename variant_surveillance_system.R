...
query = paste(
  ...
  AND lineage != "Unassigned" AND lineage IS NOT NULL'
...
# Move this part to weekly_s1_variant_report_nowcast.R --2023-01-23
...
# Move s1 part to weekly_s1_variant_nowcast.R
